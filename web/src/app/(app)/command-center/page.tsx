...
export const metadata: Metadata = {
  title: "Command Central · Spann Travel",
  description: "Playbook checklist progress and module snapshot.",
};
  ...
  return (
    <>
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-3xl font-semibold tracking-tight text-white">Command Central</h1>
      ...
      <section className="mt-10 grid gap-6 lg:grid-cols-[1.2fr_minmax(0,1fr)]">
        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-6">
          <h2 className="text-xs font-semibold uppercase tracking-[0.2em] text-teal-400/90">Per track</h2>
              ...
              return (
                <li key={list.slug} className="flex flex-col gap-1">
                  ...
                  <div className="h-2 w-full overflow-hidden rounded-full bg-black/35">
                    <div className="h-full rounded-full bg-teal-600/90" style={{ width: `${p}%` }} />
                  </div>
      ...
      <section className="mt-10 rounded-2xl border border-[var(--card-border)] bg-[var(--card)] p-6">
        <div className="flex items-center justify-between gap-4">
          <h2 className="text-xs font-semibold uppercase tracking-[0.2em] text-teal-400/90">Next immediate steps</h2>
